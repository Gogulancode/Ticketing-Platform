    ...
    public partial class AddChatEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatCannedResponses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatCannedResponses_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusEmoji = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    StatusExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    OnlineSince = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemData = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatCannedResponses_OwnerId",
                table: "ChatCannedResponses",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatCannedResponses_Shortcut",
                table: "ChatCannedResponses",
                column: "Shortcut");
