...
$deploymentFolder = "BusinessHub-Production-$timestamp"
...
if (Test-Path "web.config") {
    Copy-Item "web.config" "$deploymentFolder/web.config"
}
Write-Host "✅ Configuration files copied" -ForegroundColor Green

# Create deployment instructions
$instructionsPath = "$deploymentFolder/DEPLOYMENT_INSTRUCTIONS.txt"
$instructionsContent = @"
...
$instructionsContent | Out-File $instructionsPath -Encoding UTF8
