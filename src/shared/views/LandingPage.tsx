      ...
      <div className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <div className="mb-16">
          <div className="flex items-center justify-center mb-8">
            <NivoLogo size="lg" showText={false} />
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          {import.meta.env.VITE_ENABLE_TRAINING_MODULE === 'true' && (
            <Link
              to="/training"
              className="group relative bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-red-200 transform hover:-translate-y-2 hover:scale-105"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-red-600 rounded-3xl opacity-0 group-hover:opacity-5 transition-opacity duration-300"></div>
              <div className="relative z-10">
                <div className="flex justify-center mb-6">
                  <div className="w-16 h-16 bg-gradient-to-r from-red-500 to-red-600 rounded-2xl flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-300">
                ...
                <div className="flex items-center justify-center text-gray-600 font-semibold group-hover:text-gray-600 transition-colors">
                  Start Learning 
