...
interface AnimatedBusinessHubLogoProps {
  size?: 'sm' | 'md' | 'lg' | 'xl';
  className?: string;
}

const AnimatedBusinessHubLogo: React.FC<AnimatedBusinessHubLogoProps> = ({ 
  size = 'md', 
  className = '' 
}) => {
  const sizeClasses = {
  ...
  return (
    <div className={`${sizeClasses[size]} ${className}`}>
      ...
      >
        ...
        {/* Central Hub Icon - stays stationary */}
        <circle 
          cx="50" 
          cy="50" 
          r="8" 
        ...
        {/* Connection Lines */}
        <g stroke="white" strokeWidth="3" strokeLinecap="round" className="animate-pulse">
          {/* Top */}
        ...
        {/* Outer Nodes */}
        <g fill="white" className="animate-pulse" style={{ animationDelay: '0.5s' }}>
...
export default AnimatedBusinessHubLogo;