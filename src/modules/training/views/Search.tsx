...
import { getUploadedContent } from '../../../shared/lib/api';
...
const Search: React.FC = () => {
  ...
  return (
    <div className="space-y-sm">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 mb-xs">Search Training Content</h1>
        ...
        {results.length > 0 ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 divide-y divide-gray-200">
            {results.map(result => {
              ...
              return (
                <div key={result.id} className="p-sm hover:bg-gray-50 transition-colors">
                  <div className="flex items-start justify-between">
                    ...
                    <button className="ml-4 flex items-center px-3 py-2 text-sm font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-colors">
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow-sm border border-gray-200">
            <SearchIcon className="h-12 w-12 text-gray-400 mx-auto mb-xs" />
