...
const ContentManagement: React.FC = () => {
  ...
  if (!isAdmin) {
    return (
      <div className="p-8 text-center">
        <AlertCircle className="w-16 h-16 text-red-400 mx-auto mb-xs" />
  ...
  return (
    <div className="text-sm leading-snug space-y-sm">
      <div className="mb-sm">
        <h1 className="text-lg font-semibold leading-tight text-gray-900">Content Management</h1>
      ...
      <div className="bg-white rounded-lg shadow-md p-sm mb-sm">
        <h2 className="text-lg font-semibold text-gray-900 mb-xs">Select Module & Section</h2>
        ...
        {selectedModule && (
          <div className="mt-xs p-4 bg-blue-50 rounded-lg">
      ...
      {/* Tab Navigation */}
      {selectedModule && (
        <div className="bg-white rounded-lg shadow-md mb-sm">
          ...
          <div className="text-sm leading-snug space-y-sm">
            {activeTab === 'content' && (
              <div>
                ...
                {showContentForm && (
                  <div className="border border-gray-200 rounded-lg p-sm mb-sm">
                    <h4 className="text-lg font-semibold text-gray-900 mb-xs">Add New Content Item</h4>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-xs">
                      <div>
            ...
            {activeTab === 'assessment' && (
              <div>
                <div className="mb-sm">
                  <h3 className="text-base font-semibold text-gray-900 mb-xs">Assessment Details</h3>
                ...
                {currentAssessment.questions.length > 0 && (
                  <div className="mb-sm">
                    <h4 className="text-lg font-semibold text-gray-900 mb-xs">Questions ({currentAssessment.questions.length})</h4>
                ...
                <div className="border border-gray-200 rounded-lg p-sm mb-sm">
                  <h4 className="text-lg font-semibold text-gray-900 mb-xs">Add New Question</h4>
