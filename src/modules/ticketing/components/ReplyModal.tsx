          ...
          <div className="space-y-4">
            ...
            <div className="bg-red-50 rounded-lg p-4">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <h3 className="text-sm font-medium text-gray-900">Email Details</h3>
              </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Reply Message <span className="text-gray-500">*</span>
              </label>
              <textarea
                value={replyContent}
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-3">
              <div className="flex items-start space-x-2">
                <Reply className="w-4 h-4 text-gray-600 mt-0.5" />
                <div>
                  <h4 className="text-sm font-medium text-gray-800">Customer Reply</h4>
